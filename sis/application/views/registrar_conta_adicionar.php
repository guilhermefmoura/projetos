<div id="context">
    ...
    <div id="editarRight">
        <h1>Atalhos</h1>
        <a href="<?php print base_url(); ?>cliente/visualizarcontafancybox/<?php print $cliente->cod_cliente; ?>" class="btn-visualizar-conta" id="btn-visualizar-conta" data-fancybox-type="iframe">Visualizar Conta</a>
        <a href="<?php print base_url(); ?>desconto/descontofancybox/<?php print $cliente->cod_cliente; ?>" id="btn-desconto" class="btn-desconto" data-fancybox-type="iframe">Desconto em produto</a>
